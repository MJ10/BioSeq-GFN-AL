...
# Proxy
parser.add_argument("--proxy_learning_rate", default=1e-5)
parser.add_argument("--proxy_type", default="regression")
parser.add_argument("--proxy_arch", default="transformer")
parser.add_argument("--proxy_num_layers", default=4)
parser.add_argument("--proxy_dropout", default=0.1)

parser.add_argument("--proxy_num_hid", default=1024, type=int)
parser.add_argument("--proxy_L2", default=1e-6, type=float)
